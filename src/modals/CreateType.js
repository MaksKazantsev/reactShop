        ...
        <>
            ...
            {showModal ? (
                <>
                    ...
                    >
                        <div className="relative w-auto my-6 mx-auto max-w-3xl lg:w-[1000px]">
                            {/*content*/}
                    ...
                    <span className="bg-transparent text-black text-3xl">
                      ×
                                ...
                                <div className="relative p-6 flex-auto">
                                    <input className="my-4 text-blueGray-500 text-lg leading-relaxed w-[100%] py-2 px-5 border-2 focus:border-blue-500"/>
